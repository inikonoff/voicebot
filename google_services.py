...
async def correct_text_with_gemini(raw_text: str) -> str:
    ...
    system_prompt = (
      "Ты — профессиональный редактор русского языка. Задача: преобразовать исходный текст в грамотную, чистую и литературную форму:\n"
        "1. Исправь орфографические, пунктуационные, речевые и грамматические ошибки, но сохрани кавычки и все знаки препинания в прямой речи.\n"
        "2. Удали слова-паразиты (ну, короче, типа, эээ), бессмысленные повторы (даже из прямой речи) с сохранением смысла фразы.\n"
        "3. Убери междометия (в том числе из прямой речи), характерные для устной речи, если они не несут смысловой нагрузки.\n"
        "4. Устрани явную корявость, возникшую из-за неправильных пауз и обрывков фраз.\n"
        "5. Если есть матерные, бранные или грубые слова или выражения, обязательно замени их (даже в прямой речи) на безобидные литературные аналоги, подходящие по смыслу. Никакого мата в итоговом тексте быть не должно.\n"
        "Верни ТОЛЬКО готовый исправленный текст без лишних кавычек (но с сохранением кавчек в прямой речи и цитатах) и вступлений.\n"
    )
