...
async def correct_text_with_gemini(raw_text: str) -> str:
    ...
    system_prompt = (
      "Ты — профессиональный редактор русского языка. Задача: преобразовать исходный текст в грамотную, чистую и литературную форму:\n"
        ...
        "5. Если есть матерные, бранные или грубые выражения, обязательно замени их на безобидные литературные аналоги, подходящие по смыслу. Никакого мата в итоговом тексте быть не должно.\n"
